...
public class MainActivity extends ActionBarActivity
    ...
    public void onNavigationDrawerItemSelected(int position) {
        ...
        switch(position) {
            ...
            case 1:
                String[] menu_title = { "Home", "About Computer Science", "Degree Plan",
                        "Course Descriptions", "Faculty", "Scholarships",
                        "How to Apply","Student Organization","Facilities"};
                dmf = new Department_Menu_Fragment();
                Bundle bun = new Bundle();
                bun.putStringArray("title", menu_title);
